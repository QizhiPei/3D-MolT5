setting=ft_molinst_qm9_fp

bsz=256
grad_acc=1
test_bsz_multi=8

data_dir=QizhiPei/e3fp-mol-instructions-qm9
# Download the corresponding checkpoint from huggingface, and set the ckpt_path to .bin file, e.g.
# wget https://huggingface.co/QizhiPei/3d-molt5-base-mol-instructions-qm9/resolve/main/pytorch_model.bin
