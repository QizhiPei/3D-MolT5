setting=ft_pubchem_com_fp

bsz=96
grad_acc=4
test_bsz_multi=8

data_dir=QizhiPei/e3fp-pubchem-com
# Download the corresponding checkpoint from huggingface, and set the ckpt_path to .bin file, e.g.
# wget https://huggingface.co/QizhiPei/3d-molt5-base-pubchem-com/resolve/main/pytorch_model.bin
